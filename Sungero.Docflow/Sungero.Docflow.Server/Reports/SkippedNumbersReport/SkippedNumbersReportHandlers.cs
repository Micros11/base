...
namespace Sungero.Docflow
{
  partial class SkippedNumbersReportServerHandlers
  {
    ...
    public override void BeforeExecute(Sungero.Reporting.Server.BeforeExecuteEventArgs e)
    {
      ...
      SkippedNumbersReport.SkipedNumberList = string.Join(", ", skippedNumberList.ToArray(), 0, displayedValuesCount);
      ...
      if (hiddenSkippedNumberCount > 0)
      {
        ...
        SkippedNumbersReport.SkipedNumberList += string.Format(Sungero.Docflow.Reports.Resources.SkippedNumbersReport.And, hiddenSkippedNumberCount, numberLabel);
      }
