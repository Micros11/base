...
namespace Sungero.RecordManagement.Server
{
  partial class ActionItemExecutionTaskRouteHandlers
  {
    ...
    public virtual void Script112Execute()
    {
      ...
      // Скорректировать дерево поручений соисполнителей в соответствии с новым ответственным исполнителем.
      Functions.ActionItemExecutionTask.ChangeCoAssigneesActionItemsTree(_obj);
    }
    ...
    public virtual void Script109Execute()
    {
      ...
      // Прекратить задание старому исполнителю, если оно было заблокировано.
      Functions.ActionItemExecutionTask.AbortActionItemExecutionAssignment(_obj);
      
      // Прекратить задание старому контролеру, если оно было заблокировано.
