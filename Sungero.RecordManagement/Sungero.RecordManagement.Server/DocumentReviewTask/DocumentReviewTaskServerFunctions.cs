  ...
  partial class DocumentReviewTaskFunctions
  {
    ...
    private void AddActionItemExecutionBlocks(StateView stateView)
    {
      ...
      foreach (var actionItemExecution in actionItemExecutions)
      {
        ...
        var actionItemStateView = PublicFunctions.ActionItemExecutionTask.GetActionItemStateView(ActionItemExecutionTasks.As(actionItemExecution),
                                                                                                 null, null, null, string.Empty, null, null, true, false);
