...
namespace Sungero.RecordManagement.Client
{
  partial class ActionItemExecutionTaskActionItemPartsActions
  {
    ...
    {
      return Functions.ActionItemExecutionTask.CanChangeActionItem(_obj.ActionItemExecutionTask);
    }

    public virtual void ChangeCompoundActionItemPart(Sungero.Domain.Client.ExecuteChildCollectionActionArgs e)
    {
      var errorMessage = Functions.ActionItemExecutionTask.Remote.CheckActionItemPartEdit(_obj.ActionItemExecutionTask,
  ...
  partial class ActionItemExecutionTaskActions
  {
    ...
    public virtual void ChangeActionItem(Sungero.Domain.Client.ExecuteActionArgs e)
    {
      ...
      var actionItemChangeSuccesfullyStarted = _obj.IsCompoundActionItem == true ?
      ...
      if (actionItemChangeSuccesfullyStarted)
